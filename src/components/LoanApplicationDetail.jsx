          ...
          <section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-gray-100">
                ...
                <div>
                  <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 flex items-center gap-2">
                    <BuildingOfficeIcon className="h-4 w-4" /> Office/Business
                    Address (Geo-Fence)
                  </h4>
                  <div className="text-sm text-gray-800 leading-relaxed bg-gray-50 p-3 rounded-lg border border-gray-100">
            ...
            <div className="p-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Field
                    label={isSalaried ? "Monthly Salary" : "Monthly Net Income"}
                  ...
                  {isSalaried ? (
                    <>
                      <Field
                        ...
                        value={app.employment_type || "Private"}
                      />
                      <Field
                        label="Employer Name"
                        value={app.employer_name || "N/A"}
                      />
                    </>
                  ) : (
                    <>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                <DocItem
                  name="Identity Proof (PAN / Aadhaar)"
                  status="Verified"
                  type="PDF"
                />
                <DocItem
                  name="Address Proof (Utility Bill / Passport)"
                  status="Verified"
                  type="PDF"
                />
                <DocItem
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 flex flex-col md:flex-row gap-4 items-center">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-orange-700">
                      Required for unsecured personal loans.
                    </p>
                  </div>

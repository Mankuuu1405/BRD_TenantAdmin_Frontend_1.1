  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        {/* ✅ UPDATED: Monthly Disbursement Chart (Restriction Removed) */}
        <div className="bg-white rounded-xl shadow-card p-4 border border-gray-100 h-full">
          {hasMonthlyData ? (
              ...
              {statusItems.map(s => (
                <div key={s.label} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="inline-block h-3 w-3 rounded-sm shadow-sm" style={{ backgroundColor: s.color }}></span>

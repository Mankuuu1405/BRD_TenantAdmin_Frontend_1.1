  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Vendor Workspace</h1>
          <p className="text-sm text-gray-500">
            {getVendorTypeLabel(vendorInfo.type)} Portal - Manage assigned cases
            and reports.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <div className="text-sm text-gray-600">
            Welcome,{" "}
            <span className="font-bold text-gray-900">{vendorInfo.name}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex justify-between items-start mb-2">
            ...
            <DocumentArrowUpIcon className="w-5 h-5 text-yellow-500" />
          </div>
          <div className="text-2xl font-black text-gray-800">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
          <h3 className="font-bold text-gray-700">Assigned Cases</h3>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-2">
                        {caseItem.status !== "Completed" && (
                          <button
                            onClick={() =>
                              navigate(`/vendor/cases/${caseItem.id}/upload`)
                            }
                        ...
                        <button
                          onClick={() =>
                            navigate(`/vendor/cases/${caseItem.id}`)
                          }
                          className="text-gray-600 font-bold text-sm hover:bg-gray-50 px-3 py-1.5 rounded transition"
                        >
                          View Details
                        </button>
                      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg border border-green-100">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">
                Report submitted for Case #VLN-2023-045
              </p>
              <p className="text-xs text-gray-500">
                Property valuation completed and uploaded. Awaiting review.
              </p>
          ...
          <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">
                New case assigned: Case #LGL-2023-112
              </p>
              <p className="text-xs text-gray-500">
                Legal verification required for loan application.
              </p>
          ...
          <div className="flex items-start gap-3 p-3 bg-yellow-50 rounded-lg border border-yellow-100">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">
                Reminder: Case #VER-2023-089 due in 2 days
              </p>
              <p className="text-xs text-gray-500">
                Employment verification pending. Please complete before due
                date.
              </p>
